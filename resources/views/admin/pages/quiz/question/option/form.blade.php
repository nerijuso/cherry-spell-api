...
<div class="card-body">
    ...
    <div class="mb-3">
        ...
        @if(is_null($option->media_file_name))
            <input type="file" name="file" class="form-control">
        @else
            <div class="form-group">
                {{ trans('admin.page.quiz.questions.form.remove_image') }}
                <a href="{{route('admin.quizzes.questions.options.remove_image', ['quiz' => $quiz->id, 'question' => $question->id, 'option' => $option->id])}}" class="btn btn-danger btn-xs" style="width:25px; margin:0; padding-left:25px; height: 25px" title="{{ trans('admin.button.remove_image') }}">
            ...
            <img src="{{$option->public_media_url}}" alt="" height="50" />
        @endif
    </div>
</div>
