...
@section('page_head_title')
    <h1>{{ trans('admin.page.posts.content_header.index') }}</h1>
@endsection

@section('page_head_buttons')
    <div class="col-auto ms-auto d-print-none">
        <div class="btn-list">
            <a href="{{route('admin.cms.posts.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M12 5l0 14"></path><path d="M5 12l14 0"></path></svg>
                {{ trans('admin.page.posts.buttons.create_post') }}
            </a>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="box">
        <div class="box-header">
            <form name="filter" action="{{ route('admin.cms.posts') }}" method="GET">
                <div class="row mb-3">
                    <div class="col-lg-4 col-md-3">
                        <div class="form-group">
                            <input type="text" name="name" value="{{request('title')}}" class="form-control" placeholder="{{trans('admin.page.posts.buttons.filter_by_title')}}" aria-label="{{trans('admin.page.cms.tags.button.filter_by_title')}}">
                        </div>
                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($items as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ route('admin.cms.posts.edit', $item->id) }}">
